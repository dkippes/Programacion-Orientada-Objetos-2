...
public class Main {
    public static void main(String[] args) {
        ...
        Empleado empleadoTemporal = new EmpleadoTemporal("Cacho", "Calle sucia 900", true, parseDate("1996-11-11"),1500D, parseDate("2021-12-05"), 48);
        Empleado empleadoContratado = new EmpleadoContratado("Rodrigo", "Calle tucuman 250", false, parseDate("1950-01-10"),500D, 35, "cheque");
        empresa.addEmpleado(empleadoPermanente1)
                .addEmpleado(empleadoPermanente2)
                .addEmpleado(empleadoTemporal)
                .addEmpleado(empleadoContratado);
        ...
        System.out.println("\n***********Empleado Temporal 1***********");
        System.out.println("empleadoTemporal1.calcularEdad() = " + empleadoTemporal.calcularEdad());
        System.out.println("empleadoTemporal1.calcularSueldoBruto() = " + empleadoTemporal.calcularSueldoBruto());
        System.out.println("empleadoTemporal1.calcularRetenciones() = " + empleadoTemporal.calcularRetenciones());
        System.out.println("empleadoTemporal1.calcularSueldoNetoRestante() = " + empleadoTemporal.calcularSueldoNetoRestante());
